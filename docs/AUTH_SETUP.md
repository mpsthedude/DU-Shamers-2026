...
3. Set Supabase Auth Site URL to `https://dushamers.com/` and allow the exact redirect `https://dushamers.com/?account=setup`. These are saved. The previous GitHub Pages redirect remains allowlisted for existing links during the transition.
